...
class AllLawyer extends Component {
  state = {
    lawyers: [],
  };
    ...
    if (res.data.success) {
      this.setState({ lawyers: res.data.user });
          ...
          var newLAawyer = arrayOfObject.filter(function (arrayOfObj) {
            return arrayOfObj.profileType === "Individual";
          });
      ...
      // console.log("getAllLawyers_err----->>", res.data.error);
    }
  }
  ...
  render() {
    ...
    return (
      <div className="container mt-5">
        <h1 className="m-4">There are all Database lawyers </h1>
              ...
              <tr key={i}>
                ...
                <td>
                  <button
                    ...
                    // onClick={() => this.lawyerDelete(userData._id)}
                    onClick={() => {
                      if (
                        window.confirm(
                        ...
                        this.lawyerDelete(userData._id);
                    }}
                  >
