...
class BusinessLawyer extends Component {
  state = {
    lawyers: [],
    searchQuery: "",
  };
  ...
  async getAllData() {
    ...
    if (res.data.success === true) {
      ...
      var newLAawyer = arrayOfObject.filter(function (arrayOfObj) {
        return (
          arrayOfObj.profileType === "Individual" &&
        ...
        <div className="container ">
          <div className="row container">
            ...
            <div className="col-md-8">
              <div className=" py-3 ">
                <h3 className="m-5">Our Best Business Lawyers in Pakistan</h3>
                {/* first card */}
