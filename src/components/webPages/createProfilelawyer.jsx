...
import { updateLawyerProfile } from './../../services/lawyerServices';

class CreateProfileLawyer extends Component {
  state = {
    account: {
      city: "",
      address: "",
  ...
  handleImage = (e) => {
    ...
    // console.log("handleImage--->>", e.target.files[0]);
  ...
  async updateProfile(data) {
    console.log("updateProfile_call--->>");
      try {
        const res = await updateLawyerProfile(data);
        console.log("re_updateProfile-->", res);
        if(res.data.success){
        console.log("_updateProfile_res_success--->>", res.data.success);
        this.props.history.replace("/LawyerProfile");  
        }
        else{
          console.log("_updateProfile_res_false--->>", res.data);
          toast.error(res.data.error);
        }
      } catch (ex) {
        // this code run when server throw error 
        console.log("ex_of_updateProfile-form--->", ex);
      ...
      <div className="container">
        <div className="row m-5">
          ...
          <div className="col-md-8 registerStyle mt-5 mb-5 p-2">
            <div className="container">
              <h2 className="text-center p-3">Create Profile Lawyer/LawFirm</h2>
              <form className="pt-3 pb-5" onSubmit={this.handleSubmit}>
                ...
                <fieldset className="form-group">
                  ...
                  <div className="row">
                    <legend className="col-form-label col-sm-6 pt-0 font-weight-bold">
                      Profile type
                    </legend>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-6">
                      <div onChange={(event) => this.showNumber(event)}>
                        <input type="radio" value="true" name="showContactNo" />
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-6">
                      <div onChange={(event) => this.lawyerType(event)}>
                        ...
                        <input type="radio" value="Family" name="lawyerType" />
...
export default CreateProfileLawyer;
