...
class CreateProfileUser extends Component {
  state = {
    account: {
      city: "",
      address: "",
  ...
  handleCityChange = async (e) => {
    ...
    // console.log("handleCityChange__value----->>", e.target.value);

    const account = { ...this.state.account };

    account[e.target.name] = e.target.value;
    // console.log("name----->>", account[e.target.name]);
    // console.log("value----->>", account[e.target.value]);

    // await this.setState({ account }, function() {
    //   console.log("handleCityChange--->>", this.state.account);
    // });
      ...
      <div className="container">
        <div className="row m-5">
          ...
          <div className="col-md-8 registerStyle mt-5 mb-5 p-2">
            <div className="container">
              <h2 className="text-center p-3">Create Profile User</h2>
